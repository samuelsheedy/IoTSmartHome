        ...
        <?php
            ...
            else
            {
                if(isset($_GET["airTempDate"]))
                {
                    ...
                    $stmt = ( "SELECT airTemp FROM `airdataRoom3` WHERE timestamp BETWEEN '".$tempDate." 00:00:00' AND '".$tempDate." 23:59:59'"); //Prepare an SQL statement
                    ...
                    $stmt = ( "SELECT time FROM `airdataRoom3` WHERE timestamp BETWEEN '".$tempDate." 00:00:00' AND '".$tempDate." 23:59:59'"); //Prepare an SQL statement
                    if ($result = mysqli_query($conn, $stmt))
                    {
